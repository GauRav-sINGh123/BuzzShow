  ...
  return (
    <div className="fixed h-screen w-64 lg:w-72 p-4 flex flex-col gap-6 border-r border-white/[0.08]">
      ...
      <nav className="flex flex-col gap-2">
        <Link href="/" className="flex items-center gap-4 px-4 py-3 text-white hover-gradient rounded-lg transition-all duration-300">
          <Home className="w-5 h-5" />
          <span>Home</span>
        </Link>
        <Link href="/notifications" className="flex items-center gap-4 px-4 py-3 text-white hover-gradient rounded-lg transition-all duration-300">
          <Bell className="w-5 h-5" />
          <span>Notifications</span>
        </Link>
        <Link href="/profile" className="flex items-center gap-4 px-4 py-3 text-white hover-gradient rounded-lg transition-all duration-300">
